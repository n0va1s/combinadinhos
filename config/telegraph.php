...
return [
    ...
    'webhook' => [
         ...
         *
         * Telegraph will use this class to handle webhooks.
         * It must extend the DefStudio\Telegraph\Handlers\WebhookHandler class
         */
        'webhook_handler' => \App\Http\Webhooks\TelegraphHandler::class,
